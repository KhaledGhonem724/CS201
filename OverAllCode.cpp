...
private slots:
    ...
    void on_DQ_enqueue_buttom_clicked();
    void on_DQ_dequeue_button_clicked();
...
{
    QString link = "https://github.com/KhaledGhonem724/CS201/blob/main/CS201_project.cpp";
    QDesktopServices::openUrl(QUrl(link));
}
void MainWindow::on_show_sourceCode_on_drive_clicked()
{
    QString link = "https://drive.google.com/file/d/1Nmup4xhtf8Nz2acEmnw68sFWEU6bkffc/view?usp=sharing";
    QDesktopServices::openUrl(QUrl(link));
}
...
//////double Queue////
void MainWindow::on_DQ_enqueue_buttom_clicked() {
    int n = stoi(ui->DQ_input->displayText().toStdString());
    QString s = QString::fromStdString(dq.enqueue(n));
    ui->DQ_output->setText(s);
}
void MainWindow::on_DQ_dequeue_button_clicked() {
    QString s = QString::fromStdString(dq.dequeue());
    ui->DQ_output->setText(s);
}
